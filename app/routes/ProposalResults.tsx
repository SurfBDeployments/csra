  ...
  return (
    <>
      ...
      <div className="projects-header container">
        ...
        <h2>Proposal Summary Results</h2>
        <p className="search-info">This search looks for matches in the Proposal repository.</p>
        <nav aria-label="Main navigation">
          <p className="searchlinks"><a href="#">Corporate Sites</a> | <a href="#">Project Sites</a> | <a href="#">People</a> | <a href="/proposal" className='searchon'>Proposals</a> | <a href="/projectsummary">Project Summaries</a> | <a href="#">Corporate Documents</a> | <a href="/ppt">Resumes</a> | <a href="#">Policies &amp; Guidelines</a> | <a href="#">Advanced</a></p>
        </nav>
      </div>
              ...
              <form id="ProjectSearchForm" method="get" action="/search/">
                <table className="people-search-form">
                  <tbody>
                    ...
                    <tr>
                      <td className="label">Proposal Artifacts:</td>
                      ...
                      <td className="inlinefilter">Tools:
                        <span id="toolsInput">
                    ...
                    <tr>
                      ...
                      <td className="label">
                        ...
                        <span id="customerExperienceInput"><input type="text" id="customers" name="customers" placeholder="Enter customers" /></span>
                      </td>
                ...
                <div style={{ marginTop: '20px', textAlign: 'center' }}>
                  <button type="submit" className="button"><a href="/proposalresults">Search</a></button>
